<template>
  <section>
    <h1>Sell THE Tokens</h1>
    
    <div class="sell-token-card">
      <form class="sell-token-form" @submit.prevent="sellToken">
        ...
        <input class="large-input sell-token-btn" type="submit" value="Sell The Token">
        <p class="title-message">The money, in USD, will be credited to your credit card</p>
      </form>
    </div>
...
export default {
  ...
  methods: {
    async sellToken() {
      ...
      let success = await this.$store.dispatch('theToken/sellTokens',{ 
        address: this.account, 
        quantity: this.quantity.toString() 
      })
      console.log('sellToken', success)
